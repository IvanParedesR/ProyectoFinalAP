...
import pandas as pd
import boto3
from src.utils import download_images_for_numbers, get_logger

# Configurar logging
logger = get_logger("ExtractLoadImages")
logger.info("Comenzando descarga de imágenes ...")
...
logger.info("Imágenes subidas a S3.")
